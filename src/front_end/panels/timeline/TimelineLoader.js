...
export class TimelineLoader {
    ...
    totalSize;
    jsonTokenizer;
    constructor(client, shouldSaveTraceEventsToFile, title) {
        this.client = client;
    ...
    static loadFromCpuProfile(profile, client, title) {
        ...
        try {
            const events = TimelineModel.TimelineJSProfile.TimelineJSProfileProcessor.buildTraceProfileFromCpuProfile(profile, /* tid */ 1, /* injectPageEvent */ true);
