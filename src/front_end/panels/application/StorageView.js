...
export class StorageView extends UI.ThrottledWidget.ThrottledWidget {
    ...
    clear() {
        ...
        if (this.target) {
            ...
            if (this.storageKey) {
                StorageView.clearByStorageKey(this.target, this.storageKey, this.securityOrigin, selectedStorageTypes, includeThirdPartyCookies);
            }
    ...
    static clearByStorageKey(target, storageKey, originForCookies, selectedStorageTypes, includeThirdPartyCookies) {
...
export class ActionDelegate {
    ...
    handleClear(includeThirdPartyCookies) {
        ...
        if (storageKey) {
            StorageView.clearByStorageKey(target, storageKey, securityOrigin ? securityOrigin : undefined, AllStorageTypes, includeThirdPartyCookies);
        }
