...
export declare class StorageView extends UI.ThrottledWidget.ThrottledWidget {
    ...
    static clearByStorageKey(target: SDK.Target.Target, storageKey: string, originForCookies: string | undefined, selectedStorageTypes: string[], includeThirdPartyCookies: boolean): void;
