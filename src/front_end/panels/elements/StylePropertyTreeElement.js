...
export class StylePropertyTreeElement extends UI.TreeOutline.TreeElement {
    ...
    handleAnimationNameDefinitionActivate(animationName) {
    ...
    updateAuthoringHint() {
        ...
        for (const validator of cssRuleValidatorsMap.get(propertyName) || []) {
            const hint = validator.getHint(propertyName, this.computedStyles || undefined, this.parentsComputedStyles || undefined, localName?.toLowerCase());
            if (hint) {
