...
function nextColorFormat(color, curFormat) {
    ...
    // * hex
    switch (curFormat) {
        case "rgb" /* Common.Color.Format.RGB */:
        case "rgba" /* Common.Color.Format.RGBA */:
            return !color.hasAlpha() ? "hsl" /* Common.Color.Format.HSL */ : "hsla" /* Common.Color.Format.HSLA */;
        case "hsl" /* Common.Color.Format.HSL */:
        case "hsla" /* Common.Color.Format.HSLA */:
            return !color.hasAlpha() ? "hwb" /* Common.Color.Format.HWB */ : "hwba" /* Common.Color.Format.HWBA */;
        case "hwb" /* Common.Color.Format.HWB */:
        case "hwba" /* Common.Color.Format.HWBA */:
            if (color.nickname()) {
                return "nickname" /* Common.Color.Format.Nickname */;
            }
            return color.detectHEXFormat();
        case "shorthex" /* Common.Color.Format.ShortHEX */:
            return "hex" /* Common.Color.Format.HEX */;
        case "shorthexa" /* Common.Color.Format.ShortHEXA */:
            return "hexa" /* Common.Color.Format.HEXA */;
        case "nickname" /* Common.Color.Format.Nickname */:
            return color.detectHEXFormat();
        default:
            return "rgba" /* Common.Color.Format.RGBA */;
    }
}
