...
style.setProperty('--image-file-clear-warning_icon', 'url(\"' + new URL('./src/clear-warning_icon.svg', import.meta.url).toString() + '\")');
...
style.setProperty('--image-file-edit-icon', 'url(\"' + new URL('./src/edit-icon.svg', import.meta.url).toString() + '\")');
...
style.setProperty('--image-file-file-sync_icon', 'url(\"' + new URL('./src/file-sync_icon.svg', import.meta.url).toString() + '\")');
style.setProperty('--image-file-file_icon', 'url(\"' + new URL('./src/file_icon.svg', import.meta.url).toString() + '\")');
...
style.setProperty('--image-file-frame-embedded-icon', 'url(\"' + new URL('./src/frame-embedded-icon.svg', import.meta.url).toString() + '\")');
...
style.setProperty('--image-file-star_outline', 'url(\"' + new URL('./src/star_outline.svg', import.meta.url).toString() + '\")');
...
style.setProperty('--image-file-trash_bin_material_icon', 'url(\"' + new URL('./src/trash_bin_material_icon.svg', import.meta.url).toString() + '\")');
