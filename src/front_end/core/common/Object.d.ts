...
import { type EventDescriptor, type EventListener, type EventTarget, type EventTargetEvent, type EventPayloadToRestParameters } from './EventTarget.js';
...
export declare function eventMixin<Events, Base extends Constructor>(base: Base): {
    new (...args: any[]): {
        "__#11@#events": ObjectWrapper<Events>;
        ...
        removeEventListener<T_2 extends keyof Events>(eventType: T_2, listener: (arg0: EventTargetEvent<Events[T_2]>) => void, thisObject?: Object): void;
        hasEventListeners(eventType: keyof Events): boolean;
