...
const UIStrings = {
     ...
     */
    openWebDatabaseInsecureContext: 'WebSQL in non-secure contexts is deprecated and will be removed soon. Please use Web Storage or Indexed Database.',
    /**
...
export class DeprecationIssue extends Issue {
    ...
    getDescription() {
        ...
        switch (this.#issueDetails.type) {
            case "AuthorizationCoveredByWildcard" /* Protocol.Audits.DeprecationIssueType.AuthorizationCoveredByWildcard */:
                messageFunction = i18nLazyString(UIStrings.authorizationCoveredByWildcard);
                milestone = 97;
                break;
            case "CanRequestURLHTTPContainingNewline" /* Protocol.Audits.DeprecationIssueType.CanRequestURLHTTPContainingNewline */:
                messageFunction = i18nLazyString(UIStrings.canRequestURLHTTPContainingNewline);
                feature = 5735596811091968;
                break;
            case "ChromeLoadTimesConnectionInfo" /* Protocol.Audits.DeprecationIssueType.ChromeLoadTimesConnectionInfo */:
                messageFunction = i18nLazyString(UIStrings.chromeLoadTimesConnectionInfo);
                feature = 5637885046816768;
                break;
            case "ChromeLoadTimesFirstPaintAfterLoadTime" /* Protocol.Audits.DeprecationIssueType.ChromeLoadTimesFirstPaintAfterLoadTime */:
                messageFunction = i18nLazyString(UIStrings.chromeLoadTimesFirstPaintAfterLoadTime);
                feature = 5637885046816768;
                break;
            case "ChromeLoadTimesWasAlternateProtocolAvailable" /* Protocol.Audits.DeprecationIssueType.ChromeLoadTimesWasAlternateProtocolAvailable */:
                messageFunction = i18nLazyString(UIStrings.chromeLoadTimesWasAlternateProtocolAvailable);
                feature = 5637885046816768;
                break;
            case "CookieWithTruncatingChar" /* Protocol.Audits.DeprecationIssueType.CookieWithTruncatingChar */:
                messageFunction = i18nLazyString(UIStrings.cookieWithTruncatingChar);
                milestone = 103;
                break;
            case "CrossOriginAccessBasedOnDocumentDomain" /* Protocol.Audits.DeprecationIssueType.CrossOriginAccessBasedOnDocumentDomain */:
                messageFunction = i18nLazyString(UIStrings.crossOriginAccessBasedOnDocumentDomain);
                milestone = 109;
                break;
            case "CrossOriginWindowAlert" /* Protocol.Audits.DeprecationIssueType.CrossOriginWindowAlert */:
                messageFunction = i18nLazyString(UIStrings.crossOriginWindowApi, { PH1: 'window.alert' });
                break;
            case "CrossOriginWindowConfirm" /* Protocol.Audits.DeprecationIssueType.CrossOriginWindowConfirm */:
                messageFunction = i18nLazyString(UIStrings.crossOriginWindowApi, { PH1: 'window.confirm' });
                break;
            case "CSSSelectorInternalMediaControlsOverlayCastButton" /* Protocol.Audits.DeprecationIssueType.CSSSelectorInternalMediaControlsOverlayCastButton */:
                messageFunction = i18nLazyString(UIStrings.cssSelectorInternalMediaControlsOverlayCastButton);
                feature = 5714245488476160;
                break;
            case "DeprecationExample" /* Protocol.Audits.DeprecationIssueType.DeprecationExample */:
                messageFunction = i18nLazyString(UIStrings.deprecationExample);
                feature = 5684289032159232;
                milestone = 100;
                break;
            case "DocumentDomainSettingWithoutOriginAgentClusterHeader" /* Protocol.Audits.DeprecationIssueType.DocumentDomainSettingWithoutOriginAgentClusterHeader */:
                messageFunction = i18nLazyString(UIStrings.documentDomainSettingWithoutOriginAgentClusterHeader);
                milestone = 109;
                break;
            case "EventPath" /* Protocol.Audits.DeprecationIssueType.EventPath */:
                messageFunction = i18nLazyString(UIStrings.eventPath);
                feature = 5726124632965120;
                milestone = 109;
                break;
            case "ExpectCTHeader" /* Protocol.Audits.DeprecationIssueType.ExpectCTHeader */:
                messageFunction = i18nLazyString(UIStrings.expectCTHeader);
                feature = 6244547273687040;
                milestone = 107;
                break;
            case "GeolocationInsecureOrigin" /* Protocol.Audits.DeprecationIssueType.GeolocationInsecureOrigin */:
                messageFunction = i18nLazyString(UIStrings.geolocationInsecureOrigin);
                break;
            case "GeolocationInsecureOriginDeprecatedNotRemoved" /* Protocol.Audits.DeprecationIssueType.GeolocationInsecureOriginDeprecatedNotRemoved */:
                messageFunction = i18nLazyString(UIStrings.geolocationInsecureOriginDeprecatedNotRemoved);
                break;
            case "GetUserMediaInsecureOrigin" /* Protocol.Audits.DeprecationIssueType.GetUserMediaInsecureOrigin */:
                messageFunction = i18nLazyString(UIStrings.getUserMediaInsecureOrigin);
                break;
            case "HostCandidateAttributeGetter" /* Protocol.Audits.DeprecationIssueType.HostCandidateAttributeGetter */:
                messageFunction = i18nLazyString(UIStrings.hostCandidateAttributeGetter);
                break;
            case "IdentityInCanMakePaymentEvent" /* Protocol.Audits.DeprecationIssueType.IdentityInCanMakePaymentEvent */:
                messageFunction = i18nLazyString(UIStrings.identityInCanMakePaymentEvent);
                feature = 5190978431352832;
                break;
            case "InsecurePrivateNetworkSubresourceRequest" /* Protocol.Audits.DeprecationIssueType.InsecurePrivateNetworkSubresourceRequest */:
                messageFunction = i18nLazyString(UIStrings.insecurePrivateNetworkSubresourceRequest);
                feature = 5436853517811712;
                milestone = 92;
                break;
            case "LocalCSSFileExtensionRejected" /* Protocol.Audits.DeprecationIssueType.LocalCSSFileExtensionRejected */:
                messageFunction = i18nLazyString(UIStrings.localCSSFileExtensionRejected);
                milestone = 64;
                break;
            case "MediaSourceAbortRemove" /* Protocol.Audits.DeprecationIssueType.MediaSourceAbortRemove */:
                messageFunction = i18nLazyString(UIStrings.mediaSourceAbortRemove);
                feature = 6107495151960064;
                break;
            case "MediaSourceDurationTruncatingBuffered" /* Protocol.Audits.DeprecationIssueType.MediaSourceDurationTruncatingBuffered */:
                messageFunction = i18nLazyString(UIStrings.mediaSourceDurationTruncatingBuffered);
                feature = 6107495151960064;
                break;
            case "NoSysexWebMIDIWithoutPermission" /* Protocol.Audits.DeprecationIssueType.NoSysexWebMIDIWithoutPermission */:
                messageFunction = i18nLazyString(UIStrings.noSysexWebMIDIWithoutPermission);
                feature = 5138066234671104;
                milestone = 82;
                break;
            case "NotificationInsecureOrigin" /* Protocol.Audits.DeprecationIssueType.NotificationInsecureOrigin */:
                messageFunction = i18nLazyString(UIStrings.notificationInsecureOrigin);
                break;
            case "NotificationPermissionRequestedIframe" /* Protocol.Audits.DeprecationIssueType.NotificationPermissionRequestedIframe */:
                messageFunction = i18nLazyString(UIStrings.notificationPermissionRequestedIframe);
                feature = 6451284559265792;
                break;
            case "ObsoleteWebRtcCipherSuite" /* Protocol.Audits.DeprecationIssueType.ObsoleteWebRtcCipherSuite */:
                messageFunction = i18nLazyString(UIStrings.obsoleteWebRtcCipherSuite);
                milestone = 81;
                break;
            case "OpenWebDatabaseInsecureContext" /* Protocol.Audits.DeprecationIssueType.OpenWebDatabaseInsecureContext */:
                messageFunction = i18nLazyString(UIStrings.openWebDatabaseInsecureContext);
                feature = 5175124599767040;
                milestone = 105;
                break;
            case "PaymentInstruments" /* Protocol.Audits.DeprecationIssueType.PaymentInstruments */:
                messageFunction = i18nLazyString(UIStrings.paymentInstruments);
                feature = 5099285054488576;
                break;
            case "PaymentRequestCSPViolation" /* Protocol.Audits.DeprecationIssueType.PaymentRequestCSPViolation */:
                messageFunction = i18nLazyString(UIStrings.paymentRequestCSPViolation);
                feature = 6286595631087616;
                break;
            case "PersistentQuotaType" /* Protocol.Audits.DeprecationIssueType.PersistentQuotaType */:
                messageFunction = i18nLazyString(UIStrings.persistentQuotaType);
                feature = 5176235376246784;
                milestone = 106;
                break;
            case "PictureSourceSrc" /* Protocol.Audits.DeprecationIssueType.PictureSourceSrc */:
                messageFunction = i18nLazyString(UIStrings.pictureSourceSrc);
                break;
            case "PrefixedCancelAnimationFrame" /* Protocol.Audits.DeprecationIssueType.PrefixedCancelAnimationFrame */:
                messageFunction = i18nLazyString(UIStrings.vendorSpecificApi, { PH1: 'webkitCancelAnimationFrame', PH2: 'cancelAnimationFrame' });
                break;
            case "PrefixedRequestAnimationFrame" /* Protocol.Audits.DeprecationIssueType.PrefixedRequestAnimationFrame */:
                messageFunction = i18nLazyString(UIStrings.vendorSpecificApi, { PH1: 'webkitRequestAnimationFrame', PH2: 'requestAnimationFrame' });
                break;
            case "PrefixedStorageInfo" /* Protocol.Audits.DeprecationIssueType.PrefixedStorageInfo */:
                messageFunction = i18nLazyString(UIStrings.prefixedStorageInfo);
                break;
            case "PrefixedVideoDisplayingFullscreen" /* Protocol.Audits.DeprecationIssueType.PrefixedVideoDisplayingFullscreen */:
                ...
                break;
            case "PrefixedVideoEnterFullScreen" /* Protocol.Audits.DeprecationIssueType.PrefixedVideoEnterFullScreen */:
            ...
            case "PrefixedVideoEnterFullscreen" /* Protocol.Audits.DeprecationIssueType.PrefixedVideoEnterFullscreen */:
                messageFunction = i18nLazyString(UIStrings.deprecatedWithReplacement, { PH1: 'HTMLVideoElement.webkitEnterFullscreen()', PH2: 'Element.requestFullscreen()' });
                break;
            case "PrefixedVideoExitFullScreen" /* Protocol.Audits.DeprecationIssueType.PrefixedVideoExitFullScreen */:
            ...
            case "PrefixedVideoExitFullscreen" /* Protocol.Audits.DeprecationIssueType.PrefixedVideoExitFullscreen */:
                messageFunction = i18nLazyString(UIStrings.deprecatedWithReplacement, { PH1: 'HTMLVideoElement.webkitExitFullscreen()', PH2: 'Document.exitFullscreen()' });
                break;
            case "PrefixedVideoSupportsFullscreen" /* Protocol.Audits.DeprecationIssueType.PrefixedVideoSupportsFullscreen */:
                ...
                break;
            case "RangeExpand" /* Protocol.Audits.DeprecationIssueType.RangeExpand */:
                messageFunction =
                    i18nLazyString(UIStrings.deprecatedWithReplacement, { PH1: 'Range.expand()', PH2: 'Selection.modify()' });
                break;
            case "RequestedSubresourceWithEmbeddedCredentials" /* Protocol.Audits.DeprecationIssueType.RequestedSubresourceWithEmbeddedCredentials */:
                messageFunction = i18nLazyString(UIStrings.requestedSubresourceWithEmbeddedCredentials);
                feature = 5669008342777856;
                break;
            case "OverflowVisibleOnReplacedElement" /* Protocol.Audits.DeprecationIssueType.OverflowVisibleOnReplacedElement */:
                messageFunction = i18nLazyString(UIStrings.overflowVisibleOnReplacedElement);
                feature = 5137515594383360;
                milestone = 108;
                break;
            case "RTCConstraintEnableDtlsSrtpFalse" /* Protocol.Audits.DeprecationIssueType.RTCConstraintEnableDtlsSrtpFalse */:
                messageFunction = i18nLazyString(UIStrings.rtcConstraintEnableDtlsSrtpFalse);
                milestone = 97;
                break;
            case "RTCConstraintEnableDtlsSrtpTrue" /* Protocol.Audits.DeprecationIssueType.RTCConstraintEnableDtlsSrtpTrue */:
                messageFunction = i18nLazyString(UIStrings.rtcConstraintEnableDtlsSrtpTrue);
                milestone = 97;
                break;
            case "RTCPeerConnectionComplexPlanBSdpUsingDefaultSdpSemantics" /* Protocol.Audits.DeprecationIssueType.RTCPeerConnectionComplexPlanBSdpUsingDefaultSdpSemantics */:
                messageFunction = i18nLazyString(UIStrings.rtcPeerConnectionComplexPlanBSdpUsingDefaultSdpSemantics);
                milestone = 72;
                break;
            case "RTCPeerConnectionSdpSemanticsPlanB" /* Protocol.Audits.DeprecationIssueType.RTCPeerConnectionSdpSemanticsPlanB */:
                messageFunction = i18nLazyString(UIStrings.rtcPeerConnectionSdpSemanticsPlanB);
                feature = 5823036655665152;
                milestone = 93;
                break;
            case "RtcpMuxPolicyNegotiate" /* Protocol.Audits.DeprecationIssueType.RtcpMuxPolicyNegotiate */:
                messageFunction = i18nLazyString(UIStrings.rtcpMuxPolicyNegotiate);
                feature = 5654810086866944;
                milestone = 62;
                break;
            case "SharedArrayBufferConstructedWithoutIsolation" /* Protocol.Audits.DeprecationIssueType.SharedArrayBufferConstructedWithoutIsolation */:
                messageFunction = i18nLazyString(UIStrings.sharedArrayBufferConstructedWithoutIsolation);
                milestone = 106;
                break;
            case "TextToSpeech_DisallowedByAutoplay" /* Protocol.Audits.DeprecationIssueType.TextToSpeech_DisallowedByAutoplay */:
                messageFunction = i18nLazyString(UIStrings.textToSpeech_DisallowedByAutoplay);
                feature = 5687444770914304;
                milestone = 71;
                break;
            case "V8SharedArrayBufferConstructedInExtensionWithoutIsolation" /* Protocol.Audits.DeprecationIssueType.V8SharedArrayBufferConstructedInExtensionWithoutIsolation */:
                messageFunction = i18nLazyString(UIStrings.v8SharedArrayBufferConstructedInExtensionWithoutIsolation);
                milestone = 96;
                break;
            case "XHRJSONEncodingDetection" /* Protocol.Audits.DeprecationIssueType.XHRJSONEncodingDetection */:
                messageFunction = i18nLazyString(UIStrings.xhrJSONEncodingDetection);
                milestone = 93;
                break;
            case "XMLHttpRequestSynchronousInNonWorkerOutsideBeforeUnload" /* Protocol.Audits.DeprecationIssueType.XMLHttpRequestSynchronousInNonWorkerOutsideBeforeUnload */:
                messageFunction = i18nLazyString(UIStrings.xmlHttpRequestSynchronousInNonWorkerOutsideBeforeUnload);
                break;
            case "XRSupportsSession" /* Protocol.Audits.DeprecationIssueType.XRSupportsSession */:
