...
const eventPhasesOfInterestForTraceBounds = new Set([
    "B" /* Types.TraceEvents.TraceEventPhase.BEGIN */,
    "E" /* Types.TraceEvents.TraceEventPhase.END */,
    "X" /* Types.TraceEvents.TraceEventPhase.COMPLETE */,
    "I" /* Types.TraceEvents.TraceEventPhase.INSTANT */,
]);
