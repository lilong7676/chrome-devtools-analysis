...
export class LanguageExtensionEndpoint {
    ...
    getTypeInfo(expression, context) {
        return this.endpoint.sendRequest("getTypeInfo" /* PrivateAPI.LanguageExtensionPluginCommands.GetTypeInfo */, { expression, context });
    }
    getFormatter(expressionOrField, context) {
        return this.endpoint.sendRequest("getFormatter" /* PrivateAPI.LanguageExtensionPluginCommands.GetFormatter */, { expressionOrField, context });
    }
    getInspectableAddress(field) {
        return this.endpoint.sendRequest("getInspectableAddress" /* PrivateAPI.LanguageExtensionPluginCommands.GetInspectableAddress */, { field });
    }
